  ...
  <div id="main">
    ...
    <div class="wrapper">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Subscribe to Course</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Subscriptions</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="orders.php">All Subscriptions</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Past Subscriptions</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">List of your past subscriptions with details</p>
                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
                              ...
                              <span class="collection-header">Subscription No. '.$row['id'].'</span>
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
							...
							$id = $row1['order_id'];
								...
								echo '<form action="routers/cancel-order.php" method="post">
										...
										<button class="btn waves-effect waves-light right submit" type="submit" name="action">Cancel Subscription
