    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Subscribe to Course</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Subscription</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="orders.php">All Subscription</a>
                                </li>
								<?php
            ...
            <li class="bold"><a href="details.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Edit Information</a>
            </li>				
        </ul>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Confirm Subscription</h5>
              </div>
            </div>
          </div>
        </div>
		...
		<div class="row">
			...
			<div class="collection">
				...
				<a href="#" class="collection-item active">
					<div class="row"><div class="col s7">Balance after subscription</div><div class="col s3">$ '.($balance-$total).'</div></div>
				</a>
			</div>
		</div>
	</div>';
...
<button class="btn cyan waves-effect waves-light right" type="submit" name="action" <?php if($_POST['payment_type'] == 'Wallet') {if ($balance-$total < 0) {echo 'disabled'; }}?>>Confirm Subscription
...
<footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2021 <a class="grey-text text-lighten-4" href="../index.html" target="_blank">CsCourse</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" >CsCourse</a></span>
        </div>
    </div>
</footer>
    <!-- END FOOTER -->
