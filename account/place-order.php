...
<head>
  ...
  <title>Provide Subscription Details</title>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Subsribe to Course</a>
            </li>
                <li class="no-padding">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Provide Subscription Details</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
				<div class="container">
          <p class="caption">Provide required payment details.</p>
...
<div>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
							...
							<select id="payment_type" name="payment_type">
									...
									<option value="Alipay" <?php if(!$verified) echo 'disabled';?>>AliPay</option>							
							</select>
                        </div>
                      </div>					
                      <div class="row">
        ...
        <div class="container">
          <p class="caption">Estimated Subscription List</p>
          <div class="divider"></div>
          <!--editableTable-->
