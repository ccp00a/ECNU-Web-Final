    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Course List</a>
            </li>
                <li class="no-padding">
            ...
            <li class="bold active"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Manager Users</a>
            </li>			
        </ul>
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="price">Wallet Balance</th>						
                      </tr>
                    </thead>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><input id="'.$row['id'].'_balance" name="'.$row['id'].'_balance" value="'.$balance.'" type="number" data-error=".errorTxt01"><div class="errorTxt01"></div></td></tr>'; 					
				}
				?>
                    </tbody>
</table>
