  ...
  <div id="main">
    ...
    <div class="wrapper">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Course List</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Manage Subscriptions</a>
                            <div class="collapsible-body">
                                ...
                                if(!isset($_GET['status'])){
                                    ...
                                    "><a href="all-orders.php">All Subscriptions</a>
                                </li>
                                <?php
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">List of courses by users with details</p>
